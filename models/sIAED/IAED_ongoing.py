...
from models.Attention_ongoing import CAttention
...
class IAED(Layer):
    def __init__(self, config, target_var, name = "IAED"):
        ...
        if self.config[W_SETTINGS][W_USEATT]:
            ...
            self.ca = CAttention(self.config, causal_vec, name = self.target_var + '_CA')
    ...
    def call(self, x):
        ...
        self.past_h.assign(tf.expand_dims(h, -1))
        self.past_c.assign(tf.expand_dims(c, -1))
