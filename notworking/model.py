    ...
    def __init__(self,
        ...
        for var in self.features:           
            if use_attention_layer:
                cas.append(CausalAttention(causal_matrix[features.index(var), :], name = str(var) + '_causal_attention', config = causal_config)(input_layer))
            lstms.append(LSTM(self.units[0], 
                              name = str(var) + '_lstm', 
                              activation='tanh', 
